...
import {
    Container, Row, Col, Card, Button, Table, Modal, Form, Alert
} from "react-bootstrap";
import { useAppContext } from "../provider/AppProvider";
import { instance } from "../lib/axios";
import {
    FaChalkboardTeacher, FaUser, FaUsers, FaCalendarAlt,
    FaEdit, FaTimes, FaPlus
} from "react-icons/fa";
        ...
        try {
            if (modalType === "user") {
                ...
                if (selectedItem) {
                    ...
                    setTutors(tutors.map(t => t.id === selectedItem.id ? { ...t, ...formData } : t));
                                ...
                                <tbody>
                                    {tutors.map((tutor) => (
                                        <tr key={tutor.id}>
                                            ...
                                            <td>{tutor.rating}/5 ({tutor.totalReviews})</td>
                                            <td>
                                                <Button
                                                    variant="outline-info"
                                                    size="sm"
                        ...
                        {modalType === "user" && (
                            <>
                                ...
                                <Form.Group controlId="formPassword" className="mb-3">
                                    ...
                                    />
                                    {!selectedItem && <Form.Text className="text-muted">Mật khẩu sẽ được tạo mới hoặc cập nhật.</Form.Text>}
                                </Form.Group>
                            ...
                            <>
                                <Form.Group controlId="formUserId" className="mb-3">
                                    ...
                                    <Form.Text className="text-muted">
                                        Đảm bảo ID người dùng này tồn tại trong danh sách người dùng.
                                    </Form.Text>
                                </Form.Group>
