...
import { FaSearch, FaStar, FaMapMarkerAlt, FaClock, FaDollarSign, FaBook, FaUser } from 'react-icons/fa';
...
const TutorList = () => {
    ...
    const filteredTutors = useMemo(() => {
        return tutors.filter(tutor => {
            // Search filter
            if (filters.search && !tutor.bio.toLowerCase().includes(filters.search.toLowerCase())) {
                return false;
            }
        ...
        <Container className="py-4">
            <Row className="mb-4">
                <Col>
                    ...
                    <p className="text-muted">Tìm giáo viên phù hợp với nhu cầu học tập của bạn</p>
                </Col>
            </Row>
                                ...
                                <Card.Body className="d-flex flex-column">
                                    ...
                                    <div className="flex-grow-1">
                                        ...
                                        <div className="d-flex align-items-center mb-2">
                                            ...
                                            <span className="small">
                                                <strong>Môn học:</strong> {Array.isArray(tutor.subjects)
                                                    ? tutor.subjects.join(", ")
                                                    : tutor.subjects || ""}
                                            </span>
                                        </div>
            ...
            {filteredTutors.length > 0 && (
                <Row className="mt-4">
                    <Col className="text-center">
                        <p className="text-muted">
                            Hiển thị {filteredTutors.length} trên tổng số {tutors.length} giáo viên
                        </p>
                    </Col>
                </Row>
            )}
